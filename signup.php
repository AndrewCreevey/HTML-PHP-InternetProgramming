...
---- This file signs up a user and enters their details into the table
...
<?php
	...
	//this code was adapted from the nixon book
	echo <<<_END
	<script>
	...
	if (isset($_POST['user'])) {
		...
		if ($user == "" || $pass == "")
			...
			if ($result->num_rows)
				...
				queryMysql("INSERT INTO members VALUES('$user', '$pass', '$score')");
